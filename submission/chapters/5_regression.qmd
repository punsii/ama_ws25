...
Based on our OLS Regression result we get an `R-Squared: 0.991` Which means that the model explains 99% of the variance of the dataset. `Adj. R-Squared: 0.979` Shows that if you adjust for the number of features the amount still remains high. Showing that the majority of features play a signficant part of the analysis.
