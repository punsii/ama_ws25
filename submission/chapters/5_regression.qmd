...
- **Human Development Index (R² = 0.799)**: The strongest single predictor, showing a clear positive linear relationship. HDI combines income, education, and health indicators, making it naturally well-correlated with life expectancy.
- **Schooling (R² = 0.601)**: Education shows a strong positive relationship, confirming that countries with higher average years of schooling tend to have longer life expectancies.
...
## Polyvariate Regression Analysis
