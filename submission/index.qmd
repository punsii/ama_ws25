...
- [Principal Component Analysis](chapters/3_pca.qmd) — Dimensionality reduction and PCA-based feature combination/interpretation ~ **Jens Christian Toftdahl**.
...
- [Regression Analysis](chapters/5_regression.qmd) — OLS models with PCA-based reduction, diagnostics, and year-based out-of-sample evaluation ~ **Jens Christian Toftdahl**.
